...
batch_size = 32
#validation accuracy with 0.0004 = 0.73166
#validation accuracy with 0.004 = 0.75277
#validation accuracy with 0.04 = 0.605
learning_rate = 0.004 #10 times = 0.04, 1/10th time = 0.0004
hidden_size = 64
##########################
##### your code here #####
##########################
...
for i in range(test_y.shape[0]):
    x_i = np.argmax(probs[i])
    y_i = np.argmax(test_y[i])
    confusion_matrix[x_i, y_i] += 1
