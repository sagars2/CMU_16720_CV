...
vid_fr = []
p = np.zeros((2))
rect_og = np.load('../results/girlseqrects.npy')
...
for f in frames:
    ...
    cv2.imwrite('../results/corrected_girl_frame_{}.jpg'.format(f),image)

np.save('../results/girlseqrects-wcrt.npy',np.array(rectangle))

# g = np.load('../data/results/girlseqrects-wcrt.npy')
# print(g.shape)